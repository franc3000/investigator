...
from investigator.forms.user import PasswordForm, EmailForm, UsernameForm
from investigator.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from investigator.settings import Config
